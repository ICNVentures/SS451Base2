...
function fixedfooter() {
    ...
    function template() {
        return [
            ...
            '.fixed-footer-bottom  {color: #FFF; margin:15px 0;}',
            '.fixed-footer-bottom .pull-left a {font-size:2em; margin-right:0.5em;}',
            '.copyright-view {padding-bottom:150px !important;}',
            //'@media (max-width:767px) { .copyright-view {height: 300px !important; margin-top:25px; padding-top:0;} }',
            '</style>',
            '<nav class="navbar navbar-default">', /*to fix the footer to the bottom add 'navbar-fixed-bottom' here*/
