four51.app.directive('ordershipping', ['Order', 'Shipper', 'Address', 'AddressList', function(Order, Shipper, Address, AddressList) {
	var obj = {
		...
		controller: ['$scope', function($scope) {
			...
			{
			    //Never wipe out the first and last name of the shipper, regarding of shipping address setting.
			    ...
			    if (newValue) 
			    {
				    ...
				    {
				        //Again, never wipe out the first and last name, ever.
                        ...
                        {
					        add.FirstName = $scope.currentOrder.LineItems[0].ShipFirstName;
					        add.LastName = $scope.currentOrder.LineItems[0].ShipLastName;
                        }
