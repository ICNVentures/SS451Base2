four51.app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
    ...
    $routeProvider.
        ...
        when('/product/:productInteropID/:variantInteropID/edit/:from', {templateUrl: concatSpecFormView, controller: 'SpecFormCtrl'}).
        ...
        when('/apprcheckout/:id', { templateUrl: 'partials/checkOutView.html', controller: 'CheckOutViewCtrl' }).
        ...
        when('/cart/:productInteropID/:orderID/:lineItemIndex/:from', { templateUrl: concatProductView, controller: 'LineItemEditCtrl'}).
        when('/cart/:id', { templateUrl: 'partials/cartView.html', controller: 'CartViewCtrl' }).
        when('/apprcart/:id', { templateUrl: 'partials/cartView.html', controller: 'CartViewCtrl' }).
        ...
        when('/contactus', { templateUrl: 'contactus.html', controller: 'ContactUsCtrl' }).
        when('/approval', { templateUrl: 'partials/orderApprView.html', controller: 'OrderApprCtrl' }).
        when('/logoff', { templateUrl: 'partials/logoff.html', controller: 'LogoffCtrl' }).
        otherwise({redirectTo: '/catalog'});
    
}]);

four51.app.controller('ContactUsCtrl', ['$scope', '$routeParams',
    function($scope, $routeParams) {
	    $scope.treeCount = $scope.tree.length;
}]);